...
import CybersecuritybyDesign from '../../assets/images/Cybersecurity by Design.jpg'
import AugmentedIntelligence from '../../assets/images/AugmentedIntelligence.jpg'
import IndustryTransformation from '../../assets/images/Industry Transformation.jpeg'
import FutureReadiness from '../../assets/images/future-readiness.jpg'
import PopUp from '../PopUp/PopUp';
import Button from '../Button/Button';
import './LeftRight.css';

const LeftRight = ({ image, heading, description, imageLeft = true, button=true }) => {
  const images = {
    'adv_bg.png': AdvBg,
    'cdc_bg.png': CdcBg,
    ...
    'CybersecuritybyDesign.jpg': CybersecuritybyDesign,
    'AugmentedIntelligence.jpg': AugmentedIntelligence,
    'IndustryTransformation.jpeg': IndustryTransformation,
    'FutureReadiness.jpg': FutureReadiness,
  };
