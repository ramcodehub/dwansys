...
const CoreComponents = ({
  ...
  return (
    <div
      className="container m-0 p-0 pb-5 mt-3 bg-black"
    ...
    >
      <div className="row gx-0 core-component">
        ...
        {points.length > 0 && (
          <div className="col-lg-12 d-flex flex-column justify-content-center px-4 pt-3">
            <div className="content">
        ...
        {extraContent && (
          <div
            ...
            style={{ color: '#AAAAAA', fontSize: '1.25rem' }}
          >
            {extraContent}
          </div>
        )}
