...
const UseCases = () => {
     ...
     const activeUseCase=UseCasesData.find((UseCase)=>UseCase.tab===activeTab)
  return (
    <div className='data-management d-flex flex-column align-items-center justify-content-center '>
        <div className='pt-5 pb-4'>
          <h1 className='lh-1 m-0 p-0' style={{maxWidth:'34ch'}}>Societal Value Creation with sustainability : The Future is Industry 5.0 and beyond </h1>
          <h1 className='colored'>Human-machine collaboration & sustainability</h1>
        </div>
        <div>
