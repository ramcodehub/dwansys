...
const DataManagement = () => {
     ...
     const activeDataPillar=DataPillars.find((dataPillar)=>dataPillar.tab===activeTab)
  return (
    <div className='data-management d-flex flex-column align-items-center justify-content-center '>
        ...
        {activeDataPillar&&<div className="data-pillar my-5 py-5 ps-5 rounded-4" id={activeDataPillar.id}>
                              <LeftRight heading={activeDataPillar.name}
