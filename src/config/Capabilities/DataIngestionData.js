...
const DataIngestionData = {
  sections: [
    ...
    },
    {
      ...
      props: {
        title:
          'Extracting & Streaming Real-Time Data for Critical Applications',
        description:
        ...
        extraContent:
          'With our unwavering dedication to flawless data ingestion, you unleash the true potential of your business—faster decisions, sharper insights, and a passionate pursuit of excellence.',
        points: [
          {
