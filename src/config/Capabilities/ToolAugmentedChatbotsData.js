  ...
  sections: [
    ...
    },
    {
      ...
      props:{
        ...
        content:"Unlike conventional bots that provide static responses, a Tool Augmented Chatbot is powered by AI + API integrations. It understands queries, analyzes context, and directly executes tasks — from booking appointments to fetching real-time data, running workflows, or even generating reports."
      }
    },
    {
      type:"capabilities-content",
      props:{
        ...
        content:"Our Tool Augmented Chatbot is built with advanced AI, secure integrations, and enterprise-grade scalability. It’s not just a chatbot — it’s your always-on digital co-worker that ensures your business stays ahead."
      }
    },
    {
    type: "core-component",
      ...
      },
      {
        ...
        items: [
          ...
          },
          {
            ...
            description:
              "Checks points balance and redeems rewards."
          }
        ]
      }
    ]
