...
const AIRiskAssessmentAndUnderwritingData = {
  sections: [
    ...
    },
    {
      ...
      props: {
        content: "Lemonade Insurance leverages AI-driven underwriting to approve policies in seconds, enhancing customer experience while reducing operational costs.",
