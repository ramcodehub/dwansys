...
const AIPoweredInvestmentOptimizationData = {
  sections: [
    ...
    },
    {
      ...
      props: {
        content: " BlackRock’s pioneering AI-driven platform, Aladdin, stands as a testament to innovation—empowering financial institutions to master risk and elevate portfolios, igniting a revolution in intelligent investing that inspires hope and confidence for a brighter financial future.",
