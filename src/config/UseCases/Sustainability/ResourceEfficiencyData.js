...
const ResourceEfficiencyData = {
  sections: [
    ...
    },
    {
      ...
      props: {
        content:"A global textile company adopted our solution, leading to a 25% reduction in water consumption and a 20% decrease in energy costs, while boosting ESG ratings and investor confidence.",
